...
def main(number_of_points, k, d):
    ...
    data = []
    filepath = '/home/lujf/kd-tree-project/test_dataset/pamap2+physical+activity+monitoring/PAMAP2_Dataset/Optional/subject101.dat'
    with open(filepath, 'r') as f:    
        for line in f:
            ...
            if len(data)>=number_of_points:
                break
    print("The dataset is PAMAP, 点的个数是"+ str(len(data))+"维度是"+ str(len(sample)))
    tree = create(data)
